...
/**
 * Wolfie werewolf icon — copy of the Wolfie app's WerewolfIcon
 * for use within Shapie's UI selection screen.
 */
export default function WolfieIcon({ size = 32, className }) {
  return (
    <svg
      width={size}
      height={size}
